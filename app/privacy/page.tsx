...
export const metadata: Metadata = {
  ...
  description: "What Open Historia stores and what it sends to LLM providers.",
};
...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm leading-7 text-slate-300">
      ...
      <p className="mt-2">
        When you take a turn the entire game state (you can inspect the JSON
        payload in your browser&apos;s network tab) is sent to whichever provider
        you&apos;ve picked on setup. Their privacy policy applies.
      </p>

      <h2 className="mt-8 text-base font-semibold text-amber-500">Deletion</h2>
      <p className="mt-2">
        Delete individual saves from the timeline panel, or revoke the Google
        OAuth grant in your account settings to disconnect.
      </p>
    </main>
  );
}
